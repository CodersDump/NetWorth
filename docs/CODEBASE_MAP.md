...
### Frontend (`frontend/js/app.js` — 12991 LOC, flat global script, ~508 functions)
...
- `renderBulkRosterList()` — L7590
- `bulkAddFromRoster()` — L7604
- `copyPreviousMonthMembers()` — L7619
- `addFinanceMember()` — L7655
- `resetWalkinEdit()` — L7681
- `suggestWalkinSessions()` — L7700
- `loadFinanceWalkins()` — L7732
- `addFinanceWalkin()` — L7784
- `loadFinanceInsights()` — L7817
- `copyDuesForWhatsApp()` — L7831
- `pad(s, w)` — L7848
- `padL(s, w)` — L7849
- `line(n, o, r, p)` — L7850
- `done()` — L7860
- `fallbackCopy(text, cb)` — L7866
- `copyInsightsTableAsImage()` — L7895
- `renderInsights()` — L8027

**Match review & reorder (SuperAdmin)**  (from L8160)
- `saveFinanceSettings()` — L8162
- `loadPublicWalkins()` — L8208
- `loadReviewDay()` — L8305
- `reviewOrderChanged()` — L8349
- `renderReviewList()` — L8355
- `applyReviewOrder()` — L8416
- `updateAuthUI()` — L8444
- `hiddenNow(id, btn)` — L8472
- `refreshMySession(statusElId)` — L8557
- `setStatus(msg)` — L8558
- `openAchievementsModal()` — L8586
- `closeAchievementsModal()` — L8595
- `openAuthModal()` — L8596
- `closeAuthModal()` — L8597
- `showAuthView(view)` — L8598
- `setAuthSession(session, user, opts = {})` — L8606
- `closeCompleteProfileModal()` — L8633
- `openCompleteProfileModal()` — L8634
- `showCompleteProfileMode(mode, preselectPlayerId)` — L8649
- `populateClaimPicker(preselectPlayerId)` — L8657
- `submitClaimProfile()` — L8681
- `closeCompleteProfileModal()` — L8721
- `sanitizeNickname(raw)` — L8727
- `editDistance(a, b)` — L8732
- `checkForExistingPlayer(name, typedNickname, statusEl)` — L8754
- `submitCompleteProfile()` — L8809
- `finishRequestAndSignOut(message)` — L8885
- `doLogin()` — L8891
- `doNewPassword()` — L8944
- `doSignup()` — L8955

**Init & session restore**  (from L8997)
- `doConfirmSignup()` — L9000

**Tournaments**  (from L9016)
- `doResendConfirmCode()` — L9031
- `doForgotPassword()` — L9042
- `doConfirmForgotPassword()` — L9057
- `doLogout()` — L9069
- `restoreSession()` — L9119
- `restoreTabFromHash()` — L9163
- `addManualTeamRow()` — L9238
- `collectManualTeams()` — L9274
- `loadTournamentGroupOptions()` — L9287
- `loadTournamentParticipantsChecklist()` — L9296
- `updateParticipantsCount()` — L9326
- `collectTournamentParticipants()` — L9338
- `loadTournamentsList()` — L9342
- `submitTournamentCreation(payload)` — L9349
- `submitManualDraftCreation(group_id, name)` — L9375
- `draftPlayerName(pid)` — L9423
- `draftEveryone(t)` — L9428
- `renderManualDraftTournament(t)` — L9434
- `fetchTournamentDetail(tournamentId)` — L9533
- `fetchAndRenderTournamentDetail(tournamentId)` — L9549
- `stopSchedulePolling()` — L9580
- `startSchedulePolling(tournamentId)` — L9585
- `isSchedulePollingActiveFor(tournamentId)` — L9595
- `schedulePollTick(tournamentId)` — L9597
- `renderDraftLeaderPicker(t)` — L9628
- `saveDraftLeaders(tournamentId)` — L9648
- `renderDraftPoolBoard(t)` — L9658
- `chip(pid)` — L9663
- `draftChipTapped(pid, ev)` — L9710
- `draftPoolColumnTapped(tournamentId, poolName)` — L9717
- `draftChipDragStart(ev, pid)` — L9724
- `draftPoolDragOver(ev)` — L9729
- `draftPoolDrop(ev, tournamentId, poolName)` — L9734
- `moveDraftPlayerToPool(tournamentId, poolName, playerId)` — L9743
- `putDraftPool(tournamentId, poolName, playerIds)` — L9763
- `addNewDraftPlayer(tournamentId, groupId)` — L9773
- `removeDraftPlayer(tournamentId, playerId)` — L9799
- `lockDraftPools(tournamentId)` — L9812
- `stopDraftPolling()` — L9842
- `startDraftPolling(tournamentId)` — L9847
- `isDraftPollingActiveFor(tournamentId)` — L9860
- `pollDraftStateTick(tournamentId)` — L9862
- `draftDecidedIds(draft)` — L9873
- `renderDraftStartAuctionPanel(t)` — L9882
- `startDraftAuction(tournamentId)` — L9891
- `renderDraftAuctionRoom(t)` — L9901
- `draftAssignEligibleLeaders(t, pool)` — L9916
- `draftAssignLeaderOptionsHtml(t, pool)` — L9926
- `updateDraftAssignLeaderOptions()` — L9932
- `renderDraftOrganizerAssignPanel(t)` — L9941
- `organizerAssignPlayer(tournamentId)` — L9966
- `renderDraftLiveStatusHtml(tournamentId, draftLike)` — L9987
- `updateDraftLiveStatus(tournamentId, draftLike)` — L10022
- `renderDraftQueuePicker(t)` — L10035
- `openDraftLot(tournamentId, playerId)` — L10062
- `closeDraftLot(tournamentId)` — L10070
- `skipDraftLot(tournamentId)` — L10080
- `renderDraftBidBox()` — L10090
- `draftBidBump(delta)` — L10103
- `submitDraftBid(tournamentId)` — L10110
- `renderDraftSquadsReview(t)` — L10139
- `renderSetSquadPairsPanel(t)` — L10159
- `generateCrossSquadGroups(tournamentId, status)` — L10222
- `saveSquadPairs(tournamentId, squadId, numGroups, slotsP)` — L10239
- `generateDraftSchedule(tournamentId)` — L10260
- `renderSquadRosterEditPanel(t, allowMove)` — L10281
- `renameSquadPrompt(tournamentId, squadId)` — L10347
- `moveSquadPlayer(tournamentId)` — L10364
- `toggleSquadSubNewPlayerFields(useNew)` — L10378
- `substituteSquadPlayer(tournamentId)` — L10395
- `draftSquadName(t, squadId)` — L10447
- `toggleDraftGroupOpen(name, detailsEl)` — L10469
- `toggleDraftSquadSection(key, detailsEl)` — L10482
- `renderDraftScheduleView(t)` — L10486
- `renderProjectedKnockout(t)` — L10583
- `renderRegenerateScheduleGroupPanel(t)` — L10605
- `regenerateDraftSchedule(tournamentId)` — L10629
- `renderSquadStandingsTable(standings, projection)` — L10656
- `computeLeaderboardRows(stats, t)` — L10695
- `tallyPair(side)` — L10732
- `squadSideField(tie, sid)` — L10794
- `decidingPairKey(tie, sid)` — L10795
- `podiumRank(row)` — L10853
- `renderPlayerTournamentStatsTable(stats, t)` — L10869
- `rowHtml(row)` — L10877
- `renderTieSection(title, ties, t, stageKind)` — L10922
- `renderTieCard(tie, t, stageKind)` — L10929
- `renderTieMatchRow(tie, m, idx, t, stageKind, iLeadA, iLead)` — L10961
- `draftTieMatchAdminControlsHtml(tournamentId, tieId, idx, stageKind, sid)` — L11147
- `cancelDraftTieMatch(tournamentId, tieId, matchIndex, stageKi)` — L11155
- `forfeitDraftTieMatch(tournamentId, tieId, matchIndex, stageKi)` — L11166
- `draftPlayerPickerHtml(tournamentId, tieId, matchIndex, members)` — L11177
- `opts(selected)` — L11183
- `pickTiePlayer(tournamentId, tieId, matchIndex, playerI)` — L11203
- `pickTiePlayerPair(tournamentId, tieId, matchIndex, squadId)` — L11215
- `submitDraftTieScore(tournamentId, tieId, matchIndex, stageKi)` — L11231
- `submitDraftTieScoreDirect(tournamentId, tieId, matchIndex, stageKi)` — L11248
- `collectAllEntities(t)` — L11414
- `getAllTeamEntities(t)` — L11430
- `renderTeamCompositionBars(t, containerId)` — L11448
- `populateSubstitutionSection(t)` — L11483
- `updateSubOldPlayerOptions()` — L11494
- `formatGames(games)` — L11583
- `applyTournamentViewMode()` — L11590
- `matchTotals(match)` — L11606
- `truncateBracketName(name, maxChars = 22)` — L11614
- `renderBracketView(t)` — L11619
- `renderDraftBracketGroupsPanel(t)` — L11747
- `renderDraftBracketView(t)` — L11783
- `renderTournament(t)` — L11914
- `generateTournamentRecap(t)` — L12089
- `downloadTournamentImage()` — L12121
- `loadImg(src)` — L12148
- `sideVisuals(side)` — L12158
- `drawCard(x, y, w, match, isFinal)` — L12165
- `drawAvatars(ctx, x, y, side, isWinner)` — L12211
- `paintTeam(ctx, x, y, w, h, side, fallback)` — L12230
- `roundRect(ctx, x, y, w, h, r)` — L12258
- `downloadDraftShareImage()` — L12274
- `loadImg(src)` — L12281
- `sideAvatars(squadId)` — L12330
- `drawSide(side, sx, sy, isWinner)` — L12411
- `downloadDraftLeaderboardImage()` — L12492
- `loadImg(src)` — L12501
- `presetKeyFor(bannerCss)` — L12510

**Live scoring inside tournaments**  (from L12563)
- `copyTournamentRecap()` — L12620
- `item_has_third_place(t)` — L12631
- `submitGroupScore(tournamentId, subgroup, fixtureId)` — L12635
- `submitGroupScoreDirect(tournamentId, subgroup, fixtureId, score)` — L12641
- `submitKnockoutScore(tournamentId, roundIndex, matchIndex)` — L12678
- `submitKnockoutScoreDirect(tournamentId, roundIndex, matchIndex, sc)` — L12684
- `submitThirdPlaceScore(tournamentId)` — L12711
- `submitThirdPlaceScoreDirect(tournamentId, score_a, score_b, override)` — L12717
- `getTournamentLiveLog(matchKey)` — L12748
- `tournamentLivePoint(matchKey, side, target)` — L12753
- `tournamentUndoPoint(matchKey, target)` — L12762
- `updateTournamentLiveDisplay(matchKey, target)` — L12768
- `finishGroupLiveGame(matchKey, tournamentId, subgroup, fixtur)` — L12786
- `finishKnockoutLiveGame(matchKey, tournamentId, roundIndex, matc)` — L12800
- `finishThirdPlaceLiveGame(matchKey, tournamentId)` — L12809
- `finishDraftTieLiveGame(matchKey, tournamentId, tieId, matchInde)` — L12827
- `renderLiveScoreControls(matchKey, target, finishCallExpr, nameA,)` — L12836
- `activateTab(tabName)` — L12860
- `jumpToRecordMatch()` — L12961
- `applyTheme(theme)` — L12967
